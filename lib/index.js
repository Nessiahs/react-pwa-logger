...
var PwaLogger = (function (_super) {
    ...
    function PwaLogger(props) {
        ...
        if (props.debugConsole) {
            _this.debugConsole = props.debugConsole;
        }
        else {
            _this.debugConsole = React.createElement(DebugConsole_1.DebugConsole, null);
        }
    ...
    PwaLogger.prototype.render = function () {
        var _this = this;
        return (React.createElement(exports.ErrorContext.Provider, { value: __assign({ triggerOpen: function () { return _this.countOpen(); }, closeConsole: function () { return _this.closeConsole(); }, dumper: function () { return dump_1.dump(_this.dumper); }, isOpen: this.state.isOpen }, this.config) },
            this.state.hasError === true ? (React.createElement(ErrorPage_1.ErrorPage, { errorPage: this.errorPage })) : (this.props.children),
            React.createElement(Portal_1.Portal, { isOpen: this.state.isOpen }, this.debugConsole)));
    };
    return PwaLogger;
}(React.Component));
